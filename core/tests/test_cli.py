...
from ntube import Caption, CaptionQuery, cli, StreamQuery
from ntube.exceptions import NtubeError

parse_args = cli._parse_args


@mock.patch("ntube.cli._parse_args")
...
@mock.patch("ntube.cli.display_streams")
@mock.patch("ntube.cli.YouTube")
...
@mock.patch("ntube.cli._print_available_captions")
@mock.patch("ntube.cli.YouTube")
...
@mock.patch("ntube.cli.setup_logger", return_value=None)
...
@mock.patch("ntube.cli.YouTube", return_value=None)
...
@mock.patch("ntube.cli.YouTube", return_value=None)
@mock.patch("ntube.cli.download_by_resolution")
...
@mock.patch("ntube.cli.YouTube")
@mock.patch("ntube.cli.Playlist")
@mock.patch("ntube.cli._perform_args_on_youtube")
...
def test_download_with_playlist_video_error(
    ...
    playlist_instance = playlist.return_value
    playlist_instance.videos = videos
    perform_args_on_youtube.side_effect = NtubeError()
    # When
    cli.main()
    # Then
    playlist.assert_called()
...
@mock.patch("ntube.cli.YouTube")
@mock.patch("ntube.StreamQuery")
@mock.patch("ntube.Stream")
@mock.patch("ntube.cli._download")
...
@mock.patch("ntube.cli.YouTube")
@mock.patch("ntube.cli.ffmpeg_process")
...
@mock.patch("ntube.cli.YouTube")
@mock.patch("ntube.cli._ffmpeg_downloader")
...
@mock.patch("ntube.cli.os.unlink", return_value=None)
@mock.patch("ntube.cli.subprocess.run", return_value=None)
@mock.patch("ntube.cli._download", return_value=None)
@mock.patch("ntube.cli._unique_name", return_value=None)
...
@mock.patch("ntube.cli.download_audio")
@mock.patch("ntube.cli.YouTube.__init__", return_value=None)
...
@mock.patch("ntube.cli.os.path.exists", return_value=False)
...
@mock.patch("ntube.cli.os.path.exists")
