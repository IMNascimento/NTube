...
from ntube import Caption, CaptionQuery, captions
...
@mock.patch("ntube.captions.Caption.generate_srt_captions")
...
@mock.patch("ntube.captions.Caption.xml_captions")
...
@mock.patch("ntube.captions.request")
