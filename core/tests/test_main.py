...
def test_js_caching(cipher_signature):
    assert ntube.__js__ is not None
    assert ntube.__js_url__ is not None
    assert ntube.__js__ == cipher_signature.js
    assert ntube.__js_url__ == cipher_signature.js_url
