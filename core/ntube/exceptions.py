...
class NtubeError(Exception):
    """Base ntube exception that all others inherit.
...
class MaxRetriesExceeded(NtubeError):
    """Maximum number of retries exceeded."""


class HTMLParseError(NtubeError):
    """HTML could not be parsed"""


class ExtractError(NtubeError):
...
class VideoUnavailable(NtubeError):
