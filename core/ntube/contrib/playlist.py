...
from core.ntube import extract, request, YouTube
from core.ntube.helpers import cache, DeferredGeneratorList, install_proxy, uniqueify
...
class Playlist(Sequence):
    ...
    def last_updated(self) -> Optional[date]:
        ...
        fact that this value is returned as a string, ntube does a best-effort parsing
