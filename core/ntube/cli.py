...
from core.ntube import __version__
from core.ntube import CaptionQuery, Playlist, Stream, YouTube
from core.ntube.helpers import safe_filename, setup_logger
...
def main():
    ...
    if args.verbose:
        ...
        logger.debug(f'ntube version: {__version__}')
    ...
    if "/playlist" in args.url:
        ...
        for youtube_video in playlist.videos:
            ...
            except exceptions.ntubeError as e:
...
def _parse_args(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "The list option causes ntube cli to return a list of streams "
