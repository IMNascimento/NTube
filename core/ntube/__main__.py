"""
This module implements the core developer interface for ntube.

The problem domain of the :class:`YouTube <YouTube> class focuses almost
exclusively on the developer interface. ntube offloads the heavy lifting to
...
import core.ntube as ntube
import core.ntube.exceptions as exceptions
from core.ntube import extract, request
from core.ntube import Stream, StreamQuery
from core.ntube.helpers import install_proxy
from core.ntube.innertube import InnerTube
from core.ntube.metadata import YouTubeMetadata
from core.ntube.monostate import Monostate

logger = logging.getLogger(__name__)


class YouTube:
    """Core developer interface for ntube."""
    ...
    def __init__(
        ...
        :param func on_complete_callback:
            ...
            complete events.
        :param dict proxies:
            (Optional) A dict mapping protocol to proxy address which will be used by ntube.
    ...
    def __repr__(self):
        return f'<ntube.__main__.YouTube object: videoId={self.video_id}>'
    ...
    def js(self):
        ...
        if ntube.__js_url__ != self.js_url:
            self._js = request.get(self.js_url)
            ntube.__js__ = self._js
            ntube.__js_url__ = self.js_url
        else:
            self._js = ntube.__js__
    ...
    def fmt_streams(self):
        ...
        # https://github.com/ntube/ntube/issues/1054
        try:
    ...
    @property
    def caption_tracks(self) -> List[ntube.Caption]:
        ...
        return [ntube.Caption(track) for track in raw_tracks]

    @property
    def captions(self) -> ntube.CaptionQuery:
        """Interface to query caption tracks.

        :rtype: :class:`CaptionQuery <CaptionQuery>`.
        """
        return ntube.CaptionQuery(self.caption_tracks)
